...
// @testcase: prevent split wall in window/doors
...
public class BuildingArea : MonoBehaviour
{
	...
	public void SetSelectedWallFaceMaterials(Material innerMaterial, Material outerMaterial, Material sideMaterial)
	{
		...
		for (int i = 0; i < endpoints.Count; i++)
		{
			...
			for (int j = 0; j < lines.Count; j++)
			{
				...
				{
					// here i think we should change the materila to chosen material from the scene
	...
	void Update()
	{
		...
		//                            }
		//							/// not used for a specific purpose ===============
	...
	// this function will be used to solve task 3 
